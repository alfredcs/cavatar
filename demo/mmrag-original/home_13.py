...
with st.sidebar:
    ...
    option = st.selectbox('Choose Model',('anthropic.claude-3-sonnet-20240229-v1:0', 'anthropic.claude-v2:1', 'mistral-7b', 'gemini-pro', 'gemini-pro-vision', 'gpt-4-1106-preview', 'gpt-4-vision-preview', 'stability.stable-diffusion-xl-v1:0', 'amazon.titan-image-generator-v1', 'llava-v1.5-13b-vision', 'dall-e-3', 'gpt-3.5-turbo-0125'))
...
if upload_images or image_url:
    if option != "gemini-pro-vision" and option != "gpt-4-vision-preview" and option != 'llava-v1.5-13b-vision' and option != 'stability.stable-diffusion-xl-v1:0' and option != 'amazon.titan-image-generator-v1' and option != "anthropic.claude-3-sonnet-20240229-v1:0":
    ...
    if option == "gemini-pro-vision" or option == "gpt-4-vision-preview" or "anthropic.claude-3" not in option:
    ...
    if prompt := st.chat_input():
        ...
        elif option == "anthropic.claude-v2:1" or option == "anthropic.claude-3-sonnet-20240229-v1:0":
